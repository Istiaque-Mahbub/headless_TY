...
import shipLogo from "@/public/ship logo.png"
...
export default function Hero({
  ...
  return (
    <section className="relative z-10 w-full bg-gradient-to-r from-[#32C7AF] via-[#37C1A4] to-[#2E9E8E] text-white">
      <div className="mx-auto flex w-full max-w-[1170px] flex-col items-start gap-10 px-4 pt-12 pb-40 sm:px-6 sm:pt-16 sm:pb-56 lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:pt-20 lg:pb-88">
        ...
        <div className="relative z-99 w-full max-w-md self-center overflow-visible md:max-w-lg lg:max-w-none lg:flex-1 lg:translate-x-12 lg:translate-y-10 lg:scale-[1.35] lg:overflow-visible lg:transition-transform lg:duration-500 lg:ease-out xl:translate-x-20 xl:translate-y-14 xl:scale-[1.6]">
          <div className="relative h-40 w-full sm:h-52 md:h-64 lg:h-[380px] xl:h-[460px]">
            <Image
              src={shipLogo}
