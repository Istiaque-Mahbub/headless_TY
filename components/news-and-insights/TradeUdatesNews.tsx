...
export default function TradeUpdatesNews() {
  ...
  useEffect(() => {
    async function fetchPosts() {
      try {
        // 1️⃣ Get the category ID by slug
        const catRes = await fetch(
          "http://try-headless.local/wp-json/wp/v2/categories?slug=trade-updates"
        )
        ...
        // 2️⃣ Fetch posts in that category with _embed and per_page=6
